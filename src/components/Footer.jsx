      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              <h2 className="mb-6 text-sm font-semibold font-oregano text-gray-900 uppercase dark:text-white">
                GhibliGaze
              </h2>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 sm:justify-center sm:mt-0">
            <a
              href="#"
              className="text-[#618548] hover:text-[#4e6a3a]dark:hover:text-white"
            >
              <svg
                className="w-4 h-4"
                aria-hidden="true"
            ...
            <a
              href="#"
              className="text-[#618548] hover:text-[#4e6a3a] dark:hover:text-white ms-5"
            >
              <svg
                className="w-4 h-4"
                aria-hidden="true"
