      ...
      <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              <h2 class="mb-6 text-sm font-semibold font-oregano text-gray-900 uppercase dark:text-white">
                GhibliGaze
              </h2>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
          ...
          <div class="flex mt-4 sm:justify-center sm:mt-0">
            <a
              href="#"
              class="text-[#618548] hover:text-[#4e6a3a]dark:hover:text-white"
            >
              <svg
                class="w-4 h-4"
                aria-hidden="true"
            ...
            <a
              href="#"
              class="text-[#618548] hover:text-[#4e6a3a] dark:hover:text-white ms-5"
            >
              <svg
                class="w-4 h-4"
                aria-hidden="true"
