export default function Newsletter() {
  return (
    <section className="py-10 lg:py-10 bg-stone-100 dark:bg-gray-900" id="newletter">
      <div className="max-w-screen-xl justify-center flex-1 px-6 py-16 mx-auto lg:py-16 md:px-7">
        <div className="max-w-xl mx-auto text-center">
          ...
          <p className="mb-8 text-base font-medium text-gray-500 md:text-lg dark:text-gray-400">
            Get exclusive updates, behind-the-scenes access, and early Studio Ghibli news. Join us for the magic!
          </p>
          <div className="flex flex-wrap pb-1">
            ...
            <div className="w-full md:w-auto">
              <a className="inline-block w-full px-4 py-3 font-medium leading-5 text-center text-white bg-[#618548] border border-transparent rounded-md shadow-sm hover:bg-[#4e6a3a]" href="#">
                Subscribe
              </a>
            </div>
          </div>
          <p className="text-sm leading-loose text-center text-gray-500 dark:text-gray-400 lg:text-left lg:max-w-lg">
            ...
            <a href="#" className="text-[#618548] underline hover:text-[#4e6a3a]">
              Privacy Policy
            </a>
          </p>
        </div>
