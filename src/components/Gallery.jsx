export default function Gallery() {
  return (
    <section className="py-10 lg:py-10 bg-stone-100 dark:bg-gray-800" id="gallery-section">
      <div className="max-w-screen-xl py-4 mx-auto lg:py-6 md:px-6">
        ...
        <div className="text-center flex flex-col items-center mb-8">
          ...
          <h1 className="mt-2 text-3xl font-black font-oregano text-gray-700 md:text-5xl border-b-4 border-green-500 dark:text-gray-300">
            Gallery
          </h1>
        </div>
